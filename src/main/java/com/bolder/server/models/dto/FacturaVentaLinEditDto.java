...
public class FacturaVentaLinEditDto {
	private Long id;
	private Long IdFacturaVentaId;
	...
	public Long getIdFacturaVentaId() {
		return IdFacturaVentaId;
	}
	public void setIdFacturaVentaId(Long idFacturaVentaId) {
		IdFacturaVentaId = idFacturaVentaId;
	}
